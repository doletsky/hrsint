<div class="inner-wrapper"> 
	<div class="jobs-wrapper">
		<?$APPLICATION->IncludeComponent("bitrix:form", "vacancies", array(
			...
			"SEF_MODE" => "N",
			"SEF_FOLDER" => "/{$arFolders[LANGUAGE_ID]}/about/vacancies/",
			"AJAX_MODE" => "N",
			"AJAX_OPTION_JUMP" => "N",
			"AJAX_OPTION_STYLE" => "N",
		...
		$selectedCity=null;
		$cities=array();
		$propertyEnums = CIBlockPropertyEnum::GetList(Array("DEF"=>"DESC", "SORT"=>"ASC"), Array("IBLOCK_ID"=>$arIblockId[LANGUAGE_ID]['vacancies'], "CODE"=>"CITY"));
		...
		<div class="choice-region">
			<span class="cr-label">Vaša regija:</span>
			<form id="city-form">
		...
		<?$APPLICATION->IncludeComponent("bitrix:news.list", "vacancies", array(
			...
			"IBLOCK_ID" => $arIblockId[LANGUAGE_ID]['vacancies'],
			"NEWS_COUNT" => "200",
			"SORT_BY1" => "SORT",
			"SORT_ORDER1" => "ASC",
			"SORT_BY2" => "SORT",
