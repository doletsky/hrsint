...
$leftHalf=array('SIMPLE_QUESTION_342','SIMPLE_QUESTION_641','SIMPLE_QUESTION_379','SIMPLE_QUESTION_774', 'SIMPLE_QUESTION_431', 'SIMPLE_QUESTION_913');
$rightHalf=array('SIMPLE_QUESTION_451','SIMPLE_QUESTION_962','SIMPLE_QUESTION_491','SIMPLE_QUESTION_419', 'SIMPLE_QUESTION_508', 'SIMPLE_QUESTION_374');
?>
		...
		if($FIELD_SID=='SIMPLE_QUESTION_863'){ // URL
			...
			?>
				<div class="contacts-line <?if(in_array($FIELD_SID,$leftHalf)){?>left-half<?}?> <?if(in_array($FIELD_SID,$rightHalf)){?>right-half<?}?>">
					...
					<?if(in_array($FIELD_SID,array('SIMPLE_QUESTION_641','SIMPLE_QUESTION_774', 'SIMPLE_QUESTION_913'))){?>
