			...
			<div class="cm-filters">
				<div class="cm-country">
					<select class="styled-select-live">
						<?
						$countries=array();
						$arSectionObj=CIBlockSection::GetList(Array("sort"=>"asc"), Array("IBLOCK_ID"=>64,"SECTION_ID"=>"","ACTIVE"=>"Y"),false, Array("ID","NAME","CODE","UF_LNT_LAT","UF_ZOOM"));
						$i=0;
				...
				<div class="cm-type">
					<select class="styled-select-live">
						<option value="">Всички видове бизнес</option>
						<option value="" data-type="hotel">Хотели</option>
						<option value="" data-type="restaurant">Ресторани</option>
						<option value="" data-type="retail">На дребно</option>
						<option value="" data-type="cruise">Спа/фитнес</option>
						<option value="" data-type="warehouse">Институции</option>
						<option value="" data-type="stadium">Стадиони и неща</option>
					</select>
				</div>
			</div>
			<div class="cm-search">
				<div class="input-wrap">
					<input type="search" placeholder="Търся..." class="styled-input" id="cm-search" required>
...
<div class="clients-categories">
	<div class="inner-full-wrapper">
		<table class="cc-table">
			<tr>
				<td class="cc-hotels" data-type="hotel"><p><i></i>Хотели</p></td>
				<td class="cc-restaurants" data-type="restaurant"><p><i></i>Ресторани</p></td>
				<td class="cc-retail" data-type="retail"><p><i></i>На дребно</p></td>
				<td class="cc-cruise" data-type="cruise"><p><i></i>Спа/фитнес</p></td>
				<td class="cc-warehouse" data-type="warehouse"><p><i></i>Институции</p></td>
				<td class="cc-stadiums" data-type="stadium"><p><i></i>Стадиони и неща</p></td>
			</tr>
		</table>
	</div>
</div>
	...
	<div class="inner-wrapper">
		...
		<div class="clp-right">
			<div class="address-list-wrap">
				...
				<span class="al-close">Назад към списъка на градовете</span>
