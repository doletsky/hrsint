...
<html>
<head>
<meta name="google-site-verification" content="yCGKbES0zy01kw7XNTOSFC5deGkGZaE_3sWtK0Oo4GA" />
<meta property="og:type" content="website" />
<meta property="og:title" content="<?$APPLICATION->ShowTitle()?>" /> 
<meta property="og:url" content="http://<?=$_SERVER["HTTP_HOST"]?><?=$APPLICATION->GetCurPage()?>?noredirect" /> 
...
<link href="http://www.hrsinternational.com/favicon.ico" rel="shortcut icon" type="image/x-icon">
...
<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/styles/main.css?v=3");?>
...
elseif(LANGUAGE_ID=='hr'){
	...
	$kp='<b class="hd-order show-overlay"><i></i>Poiščite<br>brezplačno<br>svetovanje</b>';
...
<div class="total-wrapper">
	...
	<?if(in_array($APPLICATION->GetCurPage(),array(
		...
		'/svn/about/','/svn/products/',
		'/mkd/about/','/mkd/products/',
	))){?>
				...
				<div class="inner-wrapper">
					<div class="header">
						...
						<div class="h-mobile-login">
							<b class="hm-menu"></b>
							<a class="hm-login" href="<?if(LANGUAGE_ID=="ru"){?>http://support.hrsinternational.com/crm/index_ru.php<?}else{?>http://support.hrsinternational.com/crm/index.php<?}?>"><i></i></a>
							<b class="hm-search"></b>
						</div>
						<div class="h-login">
							<a class="h-login-button" href="<?if(LANGUAGE_ID=="ru"){?>http://support.hrsinternational.com/crm/index_ru.php<?}else{?>http://support.hrsinternational.com/crm/index.php<?}?>"><i></i><?=GetMessage("Вход в личный кабинет");?></a>
							<div class="h-search">
								<?
								$search=array(
									'ru' => '/rus/search/',
			...
			<div class="business-type-wrapper">
				<div class="inner-wrapper">
					...
					<?}elseif(LANGUAGE_ID=='si'){?>
						<table class="business-type three-column">
							<tr>
								<td class="bt-hotels"><a href="/svn/solution/hotels-and-resorts/"><i></i><?=GetMessage("Отели и курорты");?></a></td>
								<td class="bt-restaraunts"><a href="/svn/solution/complexes-and-restaurants/"><i></i><?=GetMessage("Рестораны и комплексы");?></a></td>
								<td class="bt-sports"><a href="/svn/solution/sports-facilities/"><i></i><?=GetMessage("Спортивные объекты");?></a></td>
							</tr>
						</table>
						<table class="business-type three-column">
							<tr>
								<td class="bt-fitness"><a href="/svn/solution/spa-and-fitness/"><i></i><?=GetMessage("SPA и фитнес");?></a></td>
								<td class="bt-retail"><a href="/svn/solution/retail/"><i></i><?=GetMessage("Ритейл");?></a></td>
								<td class="bt-study"><a href="/svn/solution/educational-institutions/"><i></i><?=GetMessage("Учебные заведения");?></a></td>
							</tr>
						</table>
					<?}elseif(LANGUAGE_ID=='mk'){?>
						<table class="business-type three-column">
							<tr>
								<td class="bt-hotels"><a href="/mkd/solution/hotels-and-resorts/"><i></i><?=GetMessage("Отели и курорты");?></a></td>
								<td class="bt-restaraunts"><a href="/mkd/solution/complexes-and-restaurants/"><i></i><?=GetMessage("Рестораны и комплексы");?></a></td>
								<td class="bt-sports"><a href="/mkd/solution/sports-facilities/"><i></i><?=GetMessage("Спортивные объекты");?></a></td>
							</tr>
						</table>
						<table class="business-type three-column">
							<tr>
								<td class="bt-fitness"><a href="/mkd/solution/spa-and-fitness/"><i></i><?=GetMessage("SPA и фитнес");?></a></td>
								<td class="bt-retail"><a href="/mkd/solution/retail/"><i></i><?=GetMessage("Ритейл");?></a></td>
								<td class="bt-study"><a href="/mkd/solution/educational-institutions/"><i></i><?=GetMessage("Учебные заведения");?></a></td>
							</tr>
						</table>
					<?}?>
				</div>
			...
			<div class="index-info">
				<div class="inner-wrapper">
					...
					<div class="ii-right">
						...
						?>
						<?
						$GLOBALS["arFilterNews"]=array("!PROPERTY_COUNTRY_BL" => $_SESSION["SV"]["COUNTRY"]);
						?>
						<?$APPLICATION->IncludeComponent("bitrix:news.list", "main_news", Array(
							...
							"SORT_BY2" => "SORT",	// Поле для второй сортировки новостей
							"SORT_ORDER2" => "ASC",	// Направление для второй сортировки новостей
							"FILTER_NAME" => "arFilterNews",	// Фильтр
							"FIELD_CODE" => array(	// Поля
								0 => "",
								1 => "",
							),
			...
			<div class="inner-header <?$APPLICATION->ShowProperty("inner-header-class");?>">
				...
				<div class="inner-wrapper">
					<div class="header">
						...
						<div class="h-login">
							<a class="h-login-button" href="<?if(LANGUAGE_ID=="ru"){?>http://support.hrsinternational.com/crm/index_ru.php<?}else{?>http://support.hrsinternational.com/crm/index.php<?}?>"><i></i><?=GetMessage("Вход в личный кабинет1");?></a>
							<div class="h-search">
								<?
								$search=array(
									'ru' => '/rus/search/',
