<div class="inner-wrapper"> 
	<div class="jobs-wrapper">
		<?$APPLICATION->IncludeComponent("bitrix:form", "vacancies", array(
			...
			"SEF_MODE" => "N",
			"SEF_FOLDER" => "/eng/about/vacancies/",
			"AJAX_MODE" => "N",
			"AJAX_OPTION_JUMP" => "N",
			"AJAX_OPTION_STYLE" => "N",
		...
		$selectedCity=null;
		$cities=array();
		$propertyEnums = CIBlockPropertyEnum::GetList(Array("DEF"=>"DESC", "SORT"=>"ASC"), Array("IBLOCK_ID"=>24, "CODE"=>"CITY"));
		...
		<div class="choice-region">
			<span class="cr-label">Your region:</span>
			<form id="city-form">
