			<div class="clr"></div>
			<div class="ab-left">
				<a href="/hun/about/team/" class="abl-title">
					<h4>A csapat</h4>
					<b class="ab-more"></b>
				</a>
				<div class="abl-text">
	...
	<div class="about-block">
		<div class="inner-wrapper">
			<div class="ab-left">
				<a href="/hun/about/hrs/" class="abl-title">
					<h4>A HRS-ről</h4>
					<b class="ab-more"></b>
				</a>
				<div class="abl-text">
	...
	<div class="about-block rightish">
		<div class="inner-wrapper">
			<div class="ab-left">
				<a href="/hun/about/client/" class="abl-title">
					<h4>Ügyfeleink</h4>
					<b class="ab-more"></b>
				</a>
				<div class="abl-text">
	...
	<div class="about-block rightish">
		<div class="inner-wrapper">
			<div class="ab-left">
				<a href="/hun/about/reviews/" class="abl-title">
					<h4>Ügyfeleink mondták</h4>
					<b class="ab-more"></b>
				</a>
				<div class="abl-text">
					<?$APPLICATION->IncludeComponent(
		...
		<div class="inner-wrapper">
			...
			<div class="ab-right">
				...
				<div class="about-map">
					...
					<b data-address="Szlovákia - Pozsony" class="am-bratislava">Pozsony</b>
		...
		<div class="ab-quick-links">
			<div class="inner-wrapper">
				<div class="ql-item left-half">
					<div class="ab-left">
						<a href="/hun/about/news/" class="abl-title">
							<h4>Hírek</h4>
							<b class="ab-more"></b>
						</a>
						<div class="abl-text">
				...
				<div class="ql-item right-half">
					<div class="ab-left">
						<a href="/hun/about/tv/" class="abl-title">
							<h4>HRS TV</h4>
							<b class="ab-more"></b>
						</a>
						<div class="abl-text">
			...
			<div class="inner-wrapper">
				<div class="ql-item left-half">
					<div class="ab-left">
						<a href="/hun/about/webinars/" class="abl-title">
							<h4>Webináriumok</h4>
							<b class="ab-more"></b>
						</a>
						<div class="abl-text">
				...
				<div class="ql-item right-half">
					<div class="ab-left">
						<a href="/hun/about/vacancies/" class="abl-title">
							<h4>Karrier</h4>
							<b class="ab-more"></b>
						</a>
						<div class="abl-text">
	...
	<div class="about-block">
		<div class="inner-wrapper">
			<div class="ab-left">
				<a href="/hun/about/partners/" class="abl-title">
					<h4>Partnereink</h4>
					<b class="ab-more"></b>
				</a>
				<div class="abl-text">
