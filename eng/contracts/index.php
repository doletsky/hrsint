...
$APPLICATION->SetTitle("Contracts");
?>
<?$APPLICATION->IncludeComponent("bitrix:news", "contracts", Array(
  "IBLOCK_TYPE" => "eng_tree",  // Тип инфоблока
  ...
  "SEF_FOLDER" => "/eng/contracts/",  // Каталог ЧПУ (относительно корня сайта)
